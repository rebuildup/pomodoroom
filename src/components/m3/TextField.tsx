		...
		return (
			<div className={`flex flex-col gap-1 ${className}`.trim()}>
				...
				<div className="relative">
					{startIcon && (
						<div
							className={`absolute top-1/2 flex items-center justify-center pointer-events-none ${isUnderlined ? "left-0 -translate-y-1/2" : "left-3 -translate-y-1/2"}`}
						>
							{startIcon}
						</div>
					)}
					...
					{endIcon && (
						<div
							className={`absolute top-1/2 flex items-center justify-center pointer-events-none ${isUnderlined ? "right-0 -translate-y-1/2" : "right-3 -translate-y-1/2"}`}
						>
							{endIcon}
						</div>
					)}
